...
public class ViewHistoryPromotionServlet extends HttpServlet {
    ...
    private final String VIEW_HISTORY_PROMOTION_PAGE = "viewHistory.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<HistoryDTO> listHistory = promotionDAO.getListHistory();
            session.setAttribute("LIST_HISTORY", listHistory);

            url = VIEW_HISTORY_PROMOTION_PAGE;

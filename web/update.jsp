            ...
            <div class="container col-xl-10 col-xxl-8 px-0 py-1" >
                <div class="row align-items-center g-lg-5 py-2">
                    <div class="col-md-10 mx-auto col-lg-5" >
                        <form action="update" method="POST" class="p-4 p-md-5 border rounded-3 bg-light" style="width: 400px">
                                        ...
                                        <c:if test="${not empty listRole}">
                                            <c:forEach var="role" items="${listRole}">
                                                <option value="${role.idRole}"
                                                        <c:if test="${dto.role eq role.role or dto.role eq role.idRole}">
                                                            selected="true"
                                                        </c:if>
                                                        >${role.role}</option>
                                            </c:forEach>
                            ...
                            <div class="collapse mt-3" id="collapseExample">
                                ...
                                <div class="form-floating mb-3" style="position: relative">
                                    <input name="txtPassword" value="" type="password" class="form-control"  placeholder="Password">
